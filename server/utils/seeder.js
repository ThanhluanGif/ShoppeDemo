...
const importData = async () => {
  try {
    ...
    const categories = await Category.insertMany([
      { name: 'Điện thoại', slug: 'dien-thoai', description: 'Smartphone chính hãng' },
      { name: 'Laptop', slug: 'laptop', description: 'Máy tính xách tay các loại' },
      { name: 'Phụ kiện', slug: 'phu-kien', description: 'Cáp, sạc, ốp lưng, sạc dự phòng' },
      { name: 'Âm thanh', slug: 'am-thanh', description: 'Tai nghe, loa Bluetooth' },
      { name: 'Đồng hồ', slug: 'dong-ho', description: 'Smartwatch, vòng đeo tay thông minh' }
    ]);
    ...
    const products = [
      {
        ...
        flashSaleStartTime: new Date(Date.now() - 86400000), // Hôm qua
        flashSaleEndTime: new Date(Date.now() + 86400000 * 3) // 3 ngày nữa
      },
      {
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1606220588913-b3aecb49204b',
        countInStock: 100,
        rating: 4.7,
        numReviews: 540,
        isFlashSale: false
      ...
      },
      {
        ...
        category: categories[3]._id,
        image: 'https://images.unsplash.com/photo-1629813098670-6da76bcdafb0',
        countInStock: 30,
        rating: 4.8,
        numReviews: 85,
        isFlashSale: true,
      ...
      },
      {
        ...
        category: categories[0]._id,
        image: 'https://images.unsplash.com/photo-1598327105666-5b89351cb315',
        countInStock: 80,
        rating: 4.7,
        numReviews: 245,
        isFlashSale: false
